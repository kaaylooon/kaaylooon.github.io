...
\section{Resumo}
Estudante focado em desenvolvimento de software com experiência prática em Python, C/C++, TypeScript, Flask, React Native e modelagem de aplicações próprias. Interesse forte por back-end, sistemas, algoritmos e arquitetura, combinado com base consistente em matemática e física.
...
\small{\item{
 \textbf{Linguagens}{: Python, C, C++, JavaScript, TypeScript, SQL} \\
 \textbf{Ferramentas}{: Git, Linux, LaTeX, Expo, AsyncStorage} \\
 \textbf{Tecnologias}{: Flask, Django, Qt, React Native, Raylib, Electron, SQLite/PostgreSQL} \\
}}
\end{itemize}
...
\begin{itemize}[leftmargin=0.15in, label={}]
\small{\item{
 \textbf{Idiomas:} Português nativo; Inglês B2/C1; Francês A1; Espanhol A1. \\
